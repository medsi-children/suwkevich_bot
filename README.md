...
Минимальный backend для Telegram-бота «Сушкевич Бот»: обычный диалог с нейросетью,
ориентированной на психиатрию, психотерапию и поддерживающий разбор жизненных ситуаций.

В проекте намеренно нет mini-app, админ-панели, кейсов, новостей, баттлов, магазина и
других игровых механик. Только Telegram webhook, LLM-ответы и база памяти пользователя.
