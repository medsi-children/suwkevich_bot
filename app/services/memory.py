...
async def _refresh_profile_from_request(
    ...
    *,
    ...
    prompt = (
        ...
        "в text и action. Они должны быть человеческими, персональными, без "
        "канцелярита и странных фраз. "
...
async def generate_lifehack_for_profile(
    ...
    *,
    ...
    prompt = (
        ...
        "В text дай 2-3 короткие фразы, в action — один понятный шаг без назидания.\n\n"
