...
def start_reply(first_name: str | None = None) -> str:
    ...
    return (
        ...
        "Можно просто написать, что с вами происходит: состояние, мысль, ситуация, "
        "отношения, тревога, злость, усталость или вопрос к психиатру/психотерапевту. "
        "Я помогу разложить это по-человечески и понять ближайший безопасный шаг."
    )
